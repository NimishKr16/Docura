...
import { FolderOpen, ViewList, ViewModule, Description } from "@mui/icons-material";
          ...
          <Box>
            {loadingDocs ? (
              ...
              >
                ...
                <Typography
                  variant="body1"
                  sx={{ color: "#6b7280", mb: 3, maxWidth: "400px", mx: "auto" }}
                >
                    ...
                    return documents.map((doc) => {
                      ...
                      try {
                        ...
                        if (textContent && textContent.trim().length > 0) {
                          ...
                          snippet = "This document is empty. Click to start writing.";
                          wordCount = 0;
                        }
                      } catch {
                          ...
                          >
                            ...
                            <Box sx={{ p: 3.5, flexGrow: 1, display: "flex", flexDirection: "column" }}>
                              ...
                              <Typography
                                variant="body2"
                                sx={{
                                  // If the snippet is the empty placeholder, style differently
                                  ...(snippet === "This document is empty. Click to start writing."
                                    ? {
                                        fontStyle: "italic",
                                        fontSize: "0.95rem",
